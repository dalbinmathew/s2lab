...
-- email VARCHAR(25) NOT NULL, phone_number INT(10), hire_date DATE, job_id INT, salary INT, manager_id INT, department_id INT,
-- FOREIGN KEY(job_id) REFERENCES jobs(job_id), FOREIGN KEY(manager_id) REFERENCES employees(employee_id), 
-- FOREIGN KEY(department_id) REFERENCES departments(department_id));
-- CREATE TABLE dependents(dependent_id INT PRIMARY KEY, first_name VARCHAR(25) NOT NULL, last_name VARCHAR(25) NOT NULL, relationship VARCHAR(25), 
...
-- ALTER TABLE locations MODIFY street_address varchar(100);
-- desc locations;
-- INSERT INTO
...
-- INSERT INTO
-- locations(location_id,street_address,postal_code,city,state_province,country_id) VALUES (1800,'147 Spadina Ave','527615','Toronto','Ontario','CA');
-- INSERT INTO
...
-- INSERT INTO
-- locations(location_id,street_address,postal_code,city,state_province,country_id) VALUES (2500,'Magdalen Centre, The Oxford Science Park','67431','Oxford','Oxford','UK');
-- INSERT INTO
...
-- ALTER TABLE jobs MODIFY job_title varchar(100);
...
-- departments(department_id,department_name,location_id) VALUES
-- (11,'Accounting',1700);
-- UPDATE departments SET location_id=2400 WHERE department_id=4;
-- UPDATE departments SET location_id=2700 WHERE department_id=7;
-- UPDATE departments SET location_id=2500 WHERE department_id=8;
